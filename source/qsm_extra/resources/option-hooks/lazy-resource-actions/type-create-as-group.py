...
def main(session):
    ...
    input_result = gui_core.GuiApplication.exec_input_dialog(
        ...
        value='类型组-{}'.format(index_maximum+1),
    ...
    if input_result:
        ...
        scr_entity = scr_stage.create_type_as_group(new_path, gui_name_chs=input_result)

        page = window.gui_get_current_page()
        page._gui_type_opt.gui_create_entity_as_group(scr_entity)
