...
class AbsGuiNodeOptForTaskRelease(_GuiBaseOpt):
    def __init__(self, window, page, session):
        super(AbsGuiNodeOptForTaskRelease, self).__init__(window, page, session)
...
class AbsPrxToolsetForTaskRelease(gui_prx_widgets.PrxBaseUnit):
    ...
    def __init__(self, window, page, session, *args, **kwargs):
        super(AbsPrxToolsetForTaskRelease, self).__init__(window, page, session, *args, **kwargs)
