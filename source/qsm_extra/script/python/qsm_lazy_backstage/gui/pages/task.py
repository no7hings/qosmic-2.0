...
import qsm_lazy_backstage.worker.server as qsm_tsk_prc_server
...
class PrxPageForTaskMonitor(prx_abstracts.AbsPrxWidget):
    QT_WIDGET_CLS = gui_qt_widgets.QtTranslucentWidget

    def __init__(self, window, session, *args, **kwargs):
        super(PrxPageForTaskMonitor, self).__init__(*args, **kwargs)
        self._window = window
        self._session = session
