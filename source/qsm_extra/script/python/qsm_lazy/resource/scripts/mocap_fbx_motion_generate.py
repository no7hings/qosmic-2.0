...
class MoCapFbxMotionGenerate(object):
    ...
    def register(self):
        ...
        scr_stage.create_or_update_parameters(self._scr_node_path, 'motion', motion_json_path)
        scr_stage.create_or_update_parameters(self._scr_node_path, 'image_sequence', image_sequence_path)
        scr_stage.create_or_update_parameters(self._scr_node_path, 'fps', metadata['fps'])
        scr_stage.create_or_update_parameters(self._scr_node_path, 'frame_count', frame_count)
        scr_stage.create_or_update_parameters(self._scr_node_path, 'start_frame', start_frame)
        scr_stage.create_or_update_parameters(self._scr_node_path, 'end_frame', end_frame)
