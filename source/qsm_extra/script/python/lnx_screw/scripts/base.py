...
class ManifestStageOpt(object):
    ...
    def create_or_update_page(self, resource_type, database_name, gui_name, gui_name_chs):
    ...
    def new_page(self, resource_type, gui_name, gui_name_chs):
        ...
        self.create_or_update_page(
            resource_type, database_name, gui_name, gui_name_chs
        )
