...
class Node(_cor_model.MediaNodeModel):
    ...
    def create(cls, root, *args, **kwargs):
        ...
        if flag is True:
            ...
            node.parameters.add_boolean(param_path='auto_update', value=True).set_options(
                gui_name='Auto Update', gui_name_chs='自动更新'
            )
...
class NodeGui(_core_gui.QtMediaNode):
    def __init__(self, *args, **kwargs):
