...
class PrxUnitForSequenceTaskOverview(_abs_unit_for_task_overview.AbsPrxUnitForTaskOverview):
    ...
    def __init__(self, window, session, *args, **kwargs):
        super(PrxUnitForSequenceTaskOverview, self).__init__(window, session, *args, **kwargs)
