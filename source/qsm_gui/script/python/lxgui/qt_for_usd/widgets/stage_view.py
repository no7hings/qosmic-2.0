    ...
    class QtUsdStageWidget(
        ...
        def _refresh_usd_stage_for_texture_preview_(
            ...
            root_layer.subLayerPaths.append(
                bsc_resource.BscResource.get('assets/library/geometry/sphere.usda')
            )
            if use_acescg is True:
                root_layer.subLayerPaths.append(
                    bsc_resource.BscResource.get('assets/library/acescg-preview-material.usda')
                )
                root_layer.subLayerPaths.append(
                    bsc_resource.BscResource.get('assets/library/acescg-preview-light.usda')
                )
            else:
                root_layer.subLayerPaths.append(
                    bsc_resource.BscResource.get('assets/library/preview-material.usda')
                )
                root_layer.subLayerPaths.append(
                    bsc_resource.BscResource.get('assets/library/preview-light.usda')
                )
            #
        ...
        def _refresh_usd_stage_for_texture_render_(
            ...
            if use_acescg is True:
                root_layer.subLayerPaths.append(
                    bsc_resource.BscResource.get('assets/library/acescg-arnold-material.usda')
                )
                root_layer.subLayerPaths.append(
                    bsc_resource.BscResource.get('assets/library/acescg-arnold-light.usda')
                )
            else:
                root_layer.subLayerPaths.append(
                    bsc_resource.BscResource.get('assets/library/arnold-material.usda')
                )
                root_layer.subLayerPaths.append(
                    bsc_resource.BscResource.get('assets/library/arnold-light.usda')
                )
            #
            for i_usd_prim in usd_core.UsdStageOpt(self._usd_stage).get_all_mesh_objs():
                usd_core.UsdMaterialAssignOpt(
        ...
        def _refresh_usd_stage_for_asset_preview_(
            ...
            root_layer.subLayerPaths.append(
                bsc_resource.BscResource.get('assets/library/camera.usda')
            )
        ...
        def _usd_set_environment_current_(self, key):
            ...
            usd_core.UsdLightOpt(prim).set_texture_file(
                bsc_resource.BscResource.get('assets/library/light/acescg/tx/{}.tx'.format(key))
            )
        ...
        def _usd_do_snapshot_(self):
            ...
            file_path = six.u('{}/snapshot/untitled-{}.png').format(d, bsc_core.BscSystem.get_time_tag())
