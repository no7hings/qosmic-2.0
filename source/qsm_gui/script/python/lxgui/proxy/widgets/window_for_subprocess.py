...
from ...qt.widgets import progress_bar_for_subprocess as _progress_bar_for_subprocess
# proxy abstracts
...
class PrxSubprocessWindow(
    ...
    def _gui_build_(self):
        ...
        # self._qt_widget.window_closed.connect(self._do_gui_stop)
    ...
    def submit(self, name, cmd_script, completed_fnc=None, failed_fnc=None):
        wgt = _progress_bar_for_subprocess.QtProgressBarForSubprocess()
