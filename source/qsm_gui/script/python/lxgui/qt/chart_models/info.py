...
class _Data(dict):
    def __init__(self, *args, **kwargs):
        super(_Data, self).__init__(*args, **kwargs)
...
class ChartModelForInfo(object):
    ...
    def update(self, x, y, w, h):
        ...
        spc = 2
        d_h = self._leaf_h
        c_w, c_h = key_w+value_w, self.compute_height_maximum()
    ...
    def draw(self, painter):
        ...
        painter.setPen(
            QtGui.QColor(31, 31, 31, 127)
        )
        painter.setBrush(
            QtGui.QBrush(QtGui.QColor(31, 31, 31, 127))
        )
    ...
    def compute_text_width_by(self, text):
        return self._font_metrics.width(text)+8
