...
class QtConnection(
    ...
    def _refresh_widget_draw_geometry_(self, rect):
        ...
        self._ng_draw_connection_coord_arrow = [
            _gui_core.GuiEllipse2d.get_coord_at_angle_(center=(x_, y_), radius=r_, angle=90+a),
            _gui_core.GuiEllipse2d.get_coord_at_angle_(center=(x_, y_), radius=r_, angle=210+a),
            _gui_core.GuiEllipse2d.get_coord_at_angle_(center=(x_, y_), radius=r_, angle=330+a),
            _gui_core.GuiEllipse2d.get_coord_at_angle_(center=(x_, y_), radius=r_, angle=90+a)
        ]
