...
class QtGeneralNodeGraph(
    ...
    _bsc_graph.AbsQtGraphDrawBaseDef,

    _bsc_graph.AbsQtNGUniverseDef
):
    NG_NODE_CLS = _node.QtGeneralNode
    NG_CONNECTION_CLS = _connection.QtConnection
    #
    NGLayoutFlag = _bsc_graph._NGLayoutFlag
    ...
    def __init__(self, *args, **kwargs):
        super(QtGeneralNodeGraph, self).__init__(*args, **kwargs)
    ...
    def _set_ng_node_add_0_(self, obj):
        ...
        if icon_file_path:
            ...
            item._set_icon_file_path_(
                _gui_core.GuiIcon.get('node/group')
            )
