...
class RsvDccSceneHookOpt(utl_rsv_obj_abstract.AbsRsvObjHookOpt):
    ...
    def do_export_asset_scene(self):
        ...
        if step in ['cam']:
            ...
            location = root
        #
        mya_location = bsc_core.BscNodePathOpt(location).translate_to(
            pathsep=pathsep
        ).to_string()
    ...
    def set_asset_camera_scene_src_create(self):
        ...
        if orig_file.get_is_exists() is True:
            ...
            if scene_src_file.get_is_exists() is True:
                ...
                mya_camera_location = bsc_core.BscNodePathOpt(camera_location).translate_to(pathsep).to_string()
                ...
                if mya_camera_group.get_is_exists() is True:
                    ...
                    mya_root = bsc_core.BscNodePathOpt(root).translate_to(pathsep).to_string()
