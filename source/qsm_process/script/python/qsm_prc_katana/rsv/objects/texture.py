...
class RsvDccTextureHookOpt(utl_rsv_obj_abstract.AbsRsvObjHookOpt):
    ...
    def do_export_asset_render_texture(self):
        ...
        bsc_storage.StgPermissionMtd.create_directory(texture_directory_path_src)
        ...
        bsc_storage.StgPermissionMtd.create_directory(texture_directory_path_tgt)
    ...
    def do_lock_asset_texture_workspace(self):
        ...
        texture_workspace_opt = gnl_rsv_objects.RsvAssetTextureOpt(
            self._rsv_task
        )
