...
class RigValidationTask(
    ...
    def __init__(self, namespace):
        ...
        if qsm_gnl_core.scheme_is_release():
            self._template_cfg = bsc_resource.BscConfigure.get_as_content('rig/adv_validation_template_new')
        else:
            self._template_cfg = bsc_resource.BscConfigure.get_as_content('rig/adv_validation_template')
