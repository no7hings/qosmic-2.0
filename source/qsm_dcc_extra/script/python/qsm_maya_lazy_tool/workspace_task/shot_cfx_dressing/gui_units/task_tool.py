            ...
            with self._window.gui_progressing(
                ...
                for i_cache_path in cache_paths:
                    if ptn_opt.check_is_matched(i_cache_path) is True:
                        ...
                        if i_resource:
                            i_resource_opt = qsm_mya_tsk_cfx_clt_scripts.CfxClothCacheOpt(i_resource)
        ...
        if rig_namespaces:
            with self._window.gui_progressing(
                ...
                for i_rig_namespace in rig_namespaces:
                    i_resource = qsm_mya_tsk_anm_core.AdvRigAsset(i_rig_namespace)
                    i_opt = qsm_mya_tsk_cfx_clt_scripts.CfxClothCacheOpt(i_resource)
                    i_opt.remove_cache()
