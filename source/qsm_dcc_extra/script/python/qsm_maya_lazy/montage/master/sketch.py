...
from ..core import component as _cor_component
...
class _SketchGraph(_cor_component._GraphBase):
...
class MasterSketchSet(_cor_sketch.AbsSketchSet):
    @classmethod
    ...
    def __init__(self, *args, **kwargs):
        super(MasterSketchSet, self).__init__(*args, **kwargs)
    ...
    def get_data_at_frame(self, frame):
        ...
        for i_sketch_key, i_sketch_path in self._sketch_map.items():
            i_sketch = _cor_base.Sketch(i_sketch_path)
    ...
    def get_orients(self):
        ...
        for i_sketch_key, i_path in self._sketch_map.items():
            dict_[i_sketch_key] = _cor_base.Sketch(i_path).get_orients()
        return dict_
