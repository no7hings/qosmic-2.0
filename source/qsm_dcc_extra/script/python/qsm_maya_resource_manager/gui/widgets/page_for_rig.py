...
class PrxPageForRigResource(prx_abstracts.AbsPrxWidget):
    ...
    def _do_dcc_register_all_script_jobs(self):
        ...
        self._script_job.register(
            self._gui_utility_opt.do_gui_refresh_by_dcc_frame_changing,
    ...
    def gui_setup_page(self):
        ...
        self._gui_resource_opt = _unit_for_rig.UnitForRigView(
        ...
        self._tool_prx_tab_box.set_history_key('resource-manager.rig_page_key_current')
