...
class ShotAnimationCacheOpt(qsm_mya_rsc_core.AssetCacheOpt):
    CACHE_ROOT = qsm_mya_gnl_core.ResourceCacheNodes.AnimationRoot
    CACHE_NAME = qsm_mya_gnl_core.ResourceCacheNodes.AnimationName
...
class ShotAnimationCacheSync:
    ...
    def cfx_load_ani_cache_auto_fnc(cls, directory_path, rig_namespace):
        import qsm_maya_lazy_workspace.tasks.shot_cfx_cloth.dcc_core as c
