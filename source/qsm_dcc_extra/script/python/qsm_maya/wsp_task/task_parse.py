...
class TaskParse(qsm_dcc_wsp_task.TaskParse):
    ...
    def generate_task_session_by_asset_source_scene_src_auto(cls):
        return cls.generate_task_session_by_asset_source_scene_src(
    ...
    def generate_task_session_by_asset_source_scene_src(cls, scene_path):
        ...
        ptn_opt = task_parse.asset_source_task_scene_pattern_opt
    ...
    def generate_task_session_by_asset_release_scene_src(cls, scene_path):
        ...
        ptn_opt = task_parse.asset_release_task_scene_pattern_opt
        variants = ptn_opt.get_variants(scene_path, extract=True)
        if variants:
            if 'asset' in variants:
                variants['resource_type'] = 'asset'
