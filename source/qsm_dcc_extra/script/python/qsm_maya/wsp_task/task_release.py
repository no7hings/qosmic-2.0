...
class MayaGnlReleaseOpt(qsm_dcc_wsp_task.DccTaskReleaseOpt):
    @classmethod
    def test(cls):
        from qsm_maya.wsp_task import task_parse
    ...
    def __init__(self, *args, **kwargs):
        super(MayaGnlReleaseOpt, self).__init__(*args, **kwargs)

    def release_scene_src(self, *args, **kwargs):
        pass


class MayaAssetGnlReleaseOpt(MayaGnlReleaseOpt):
    ...
    def release_scene_src(self, *args, **kwargs):
        ...
        if result is True:
            ...
            release_scene_src_path_new = self._task_session.get_file_for(
                'asset-release-scene_src-maya-file', version=version_new
            )
            ...
            if images:
                preview_path = self._task_session.get_file_for(
                    'asset-release-preview-movie-file', version=version_new
                )
...
class MayaAssetCfxRigReleaseOpt(MayaAssetGnlReleaseOpt):
    def __init__(self, *args, **kwargs):
