...
from ...cfx_rig import core as _tsk_cfx_rig_core

from . import cfx_group as _cfx_group


class CfxClothAssetOpt(object):
    def __init__(self, rig_namespace):
        self._rig_namespace = rig_namespace
        self._rig_opt = _tsk_anm_core.AdvRigAsset(rig_namespace)
    ...
    def load_cfx_rig_from(self, scene_path):
        ...
        for i_location in locations:
            _cfx_group.ShotCfxRigGroupOpt().add_one(i_location)
    ...
    def connect_hidden(self):
        layer_name = _tsk_cfx_rig_core.CfxSourceGeoLyrOpt.NAME
...
class CfxRigAssetShit(object):
    ...
    def find_source_geo_layer(self):
        return qsm_mya_core.Namespace.find_one(
            self._namespace, node_name=_tsk_cfx_rig_core.CfxSourceGeoLyrOpt.NAME
        )
    ...
    def generate_component_data(self):
        ...
        if dcc_location:
            ...
            return _tsk_cfx_rig_core.AssetCfxRigGroupOpt.generate_component_data_for(dcc_location, gui_location)
        return {}
