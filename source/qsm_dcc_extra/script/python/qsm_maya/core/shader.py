...
class Shader(object):
    ...
    @classmethod
    def create_for(cls, shader_type, shape, components):
        ...
        material_assign_map = _shape.Geometry.get_material_assign_map(shape)
        material = material_assign_map[components[0]]
