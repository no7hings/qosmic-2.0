...
from . import task_release as _task_release
...
class TaskSession(qsm_dcc_wsp_task.TaskSession):
    ...
    def generate_task_create_opt(self):
        ...
        if 'asset' in self._properties:
            ...
            if task == 'cfx_cloth':
                return _task_create.MayaShotCfxClothCreateOpt(
                    self, self._properties
                )
            elif task == 'cfx_dressing':
                return _task_create.MayaShotCfxDressingCreateOpt(
                    self, self._properties
                )
            return _task_create.MayaAssetGnlTaskCreateOpt(
                self, self._properties
    ...
    def generate_task_release_opt(self):
        ...
        if 'asset' in self._properties:
            if task == 'cfx_rig':
                return _task_release.MayaAssetCfxRigReleaseOpt(
                    self, self._properties
                )
