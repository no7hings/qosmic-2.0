...
def asset_cfx_rig_release_fnc(option_opt):
    ...
    import lnx_maya_wotrix.tasks.asset_cfx_rig.dcc_processes.task_release as p
...
def shot_cfx_dressing_release_fnc(option_opt):
    ...
    import lnx_maya_wotrix.tasks.shot_cfx_dressing.dcc_processes.task_release as p
