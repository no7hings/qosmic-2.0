...
c.Crypto.write_encrypted_data_to_json(
    'E:/myworkspace/qosmic-2.0/source/qsm_resora/resources/verify/resora-secondary.json', iv, d
)
iv, d = c.Crypto.read_encrypted_data_from_json(
    'E:/myworkspace/qosmic-2.0/source/qsm_resora/resources/verify/resora-secondary.json'
)
print(c.Crypto.decrypt(key, iv, d))
