...
class AbsObjDagPath(object):
    ...
    def get_name(self):
        return bsc_core.BscNodePath.to_dag_name(
    ...
    def get_component_paths(self):
        return bsc_core.BscNodePath.get_dag_component_paths(
            path=self._path, pathsep=self._pathsep
        )
    ...
    def translate_to(self, pathsep):
        return self.__class__(
            bsc_core.BscNodePath.get_dag_pathsep_replace(
                self.path,
    ...
    def clear_namespace_to(self):
        return self.__class__(
            bsc_core.BscNodePath.get_dag_path_with_namespace_clear(
                self.path,
...
class AbsPortDagPath(object):
    ...
    @property
    def name(self):
        return bsc_core.BscPortPath.to_dag_name(
            path=self._path, pathsep=self._pathsep
        )
