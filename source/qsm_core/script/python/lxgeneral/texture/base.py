...
class TxrMethodForBuild(_AbsTxrBase):
    ...
    def _generate_content(cls):
        if cls.CONTENT is not None:
            return cls.CONTENT
        cls.CONTENT = bsc_resource.BscConfigure.get_as_content('texture/build')
...
class TxrMethodForColorSpaceAsAces(_AbsTxrBase):
    ...
    def _generate_content(cls):
        if cls.CONTENT is not None:
            return cls.CONTENT
        cls.CONTENT = bsc_resource.BscConfigure.get_as_content('texture/color-space/aces')
        cls.CONTENT.do_flatten()
        return cls.CONTENT
...
class TxrMethodForColorSpaceAsTxConvert(_AbsTxrBase):
    ...
    def _generate_content(cls):
        if cls.CONTENT is not None:
            return cls.CONTENT
        cls.CONTENT = bsc_resource.BscConfigure.get_as_content('texture/color-space/convert')
        cls.CONTENT.do_flatten()
        return cls.CONTENT
